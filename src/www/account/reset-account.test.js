...
describe('/account/reset-account', () => {
  ...
  describe('submit', () => {
    it('should reset session key', async () => {
      ...
      assert.notStrictEqual(account.resetCodeLastUsedAt, undefined)
      assert.notStrictEqual(account.resetCodeLastUsedAt, null)
      assert.notStrictEqual(account.sessionKeyLastResetAt, undefined)
      assert.notStrictEqual(account.sessionKeyLastResetAt, null)
    })
