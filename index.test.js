...
const properties = [
  ...
  { camelCase: 'contentSecurityPolicy', raw: 'CONTENT_SECURITY_POLICY', description: 'Value for content-security-policy header', value: "default-src 'none'", noDefaultValue: true, valueDescription: 'CSP header' },
